...
<Warning level="medium">Impact Factorだけで論文を選ぶと、低IFジャーナルに掲載された質の高い研究を見逃す。AIによる包含/除外基準ベースのスクリーニングで、選択バイアスを軽減できる。</Warning>
...
<Callout type="insight" title="AIが最も効果を発揮するステップ">Step 1（PICO構造化）とStep 2（スクリーニング）は従来法比で93-95%の時間短縮が可能。一方、Step 3（論文評価）はAI支援でも67%の短縮にとどまる。論文の全文精読と臨床的判断は、医師自身が行う必要があるためである。</Callout>
