...
description: "Claude Codeによるgit status確認、差分分析、コミットメッセージ生成、PR作成。日常のGitワークフローがどう変わるかを解説する。"
...
**Gitの操作は開発の根幹である。Claude Codeは、状態確認からコミット、PR作成まで、Gitワークフロー全体を一貫して支援する。**
...
4. 変更内容を分析し、**Conventional Commits**形式でメッセージを生成
