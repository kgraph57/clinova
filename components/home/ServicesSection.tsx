...
import { ArrowUpRight, Baby, Activity, Heart, GraduationCap } from "lucide-react";
...
const SERVICES: Service[] = [
  ...
  },
  {
    ...
    repo: "nutri-care",
    description:
      "臨床栄養管理アプリ。379製品のデータベースとNRS-2002/MNA-SF/GLIM栄養スクリーニングなど15の臨床機能で、エビデンスに基づく栄養サポートを提供します。",
    url: "/icu-nutricare",
    internal: true,
    icon: Activity,
    language: "TypeScript",
