...
export const metadata: Metadata = {
  title: "Nutri-Care",
  description:
    "臨床栄養管理アプリ。379製品のデータベースと15の臨床機能で、エビデンスに基づく栄養サポートを提供。",
  openGraph: {
    title: "NutriCare — 臨床栄養管理を定量化する",
    description:
      "経腸栄養・静脈栄養の成分を自動計算し、充足度をスコアリング。NRS-2002/MNA-SF/GLIM栄養スクリーニングから投与プロトコル生成まで。",
  },
};
...
export default function IcuNutriCarePage() {
  const jsonLd = {
    ...
    operatingSystem: "Web",
    description:
      "臨床栄養管理Webアプリケーション。経腸栄養・静脈栄養を一元管理。",
